...
Para **você**: um cartão do **USDT/BRL** com o resumo dos dois timeframes — último fechamento, lado e distância da EMA89 **em porcentagem**, RSI, ADX com DI+/DI−, estrutura, situação dos níveis manuais e ATR **em porcentagem** —, mais os alertas técnicos como etiquetas.
